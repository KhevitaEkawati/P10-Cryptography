...
public class AsymetricRSA {
    public static void generateKey(String privateKeyFile, String publicKeyFile) {
        ...
        try {
            ...
            oosPrivate = new ObjectOutputStream(fPublic);
            oosPrivate.writeObject(key.getPublic());
            oosPrivate.close();
        ...
        public static byte [] encrypt(String message, PublicKey key) {
            ...
            try {
                ...
                cipher = cipher.doFinal(message.getBytes());
        ...
        String message = "Asymetric Cryptography dengan alogritm RSA";
